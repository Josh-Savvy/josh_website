        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="pl-5">
            <div className="flex justify-between">
              <div>
                <h3 className="md:text-3xl text-lg animate__animated animate__slideInLeft font-bold dark:text-zinc-100 text-zinc-800">
                  120
                  <span className="text-green-600 font-bold">
                    <i className="bx bx-plus font-bold animate__animated animate__bounceInDown"></i>
                  </span>
                </h3>
            ...
            <div className="md:mt-10 mt-5">
              <h3 className="md:text-4xl text-xl font-semibold dark:text-zinc-100 text-black animate__animated animate__bounceInLeft">
                Glad to Help you!
              </h3>
              <p className="dark:text-zinc-100 text-black mt-5 animate__animated animate__slideInRight">
