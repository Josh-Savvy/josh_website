...
const ExperienceCard = ({ position, imgUrl, company, duration, jobType }) => {
  return (
        ...
        <div className="md:w-2/5">
          <div className="flex justify-center md:justify-start">
            <span className="shrink-0">
              <img
                src={imgUrl}
                className="h-auto w-20 rounded-md mb-6 md:mb-0"
                alt=""
              />
            </span>
          ...
          <div className="relative flex md:pl-18">
            <div className="mt-1 flex">
              ...
              <div className="md:-mt-1 md:pl-8">
                ...
                {jobType && (
                  <div className="block pt-2 font-semibold dark:text-green-600 text-zinc-500">
                    Job Type: {jobType}
                  </div>
                )}
              </div>
